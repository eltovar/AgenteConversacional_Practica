...
LAYOUT = {
    ...
    "ESTADO.md":               ("",                       "00 - ESTADO de la Planeacion"),
    "00-INDICE.md":            ("",                       "00 - Indice Maestro"),
    "AUDITORIA.md":            ("",                       "00 - Auditoria de la Documentacion"),
    ...
    "04-inventario-actual.md": ("Fase 1 - Comportamiento", "04 - Inventario de Capacidades Actuales"),
    "05-casos-de-uso.md":     ("Fase 1 - Comportamiento", "05 - Casos de Uso"),
    "06-matriz-permisos.md":  ("Fase 1 - Comportamiento", "06 - Matriz de Permisos"),
    "07-journey-maps.md":     ("Fase 1 - Comportamiento", "07 - Journey Maps"),
    "08-maquinas-de-estado.md": ("Fase 1 - Comportamiento", "08 - Maquinas de Estado"),
    "09-catalogo-eventos.md": ("Fase 1 - Comportamiento", "09 - Catalogo de Eventos"),
    "10-modelo-de-datos.md":  ("Fase 2 - Estructura",   "10 - Modelo de Dominio y Datos"),
    "11-fuentes-de-verdad.md": ("Fase 2 - Estructura",   "11 - Politica de Fuente de Verdad"),
    "15-nfr.md":              ("Fase 2 - Estructura",   "15 - Requisitos No Funcionales"),
    "12-arquitectura.md":     ("Fase 2 - Estructura",   "12 - Arquitectura Objetivo"),
