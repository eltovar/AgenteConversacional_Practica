"""
scripts/audit_visibility.py
===========================

Auditoría de integridad de la visibilidad del panel — SOLO LECTURA.
...
Uso:
    railway run python scripts/audit_visibility.py
    railway run python scripts/audit_visibility.py --hours 168 --json salida.json
...
async def _connect_redis(aioredis, explicit: Optional[str]):
    ...
    túnel con `railway connect redis` — mismo patrón que scripts/audit_inbox.py.
