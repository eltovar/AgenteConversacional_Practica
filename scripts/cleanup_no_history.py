...
MONGO_URL = os.getenv("MONGO_PUBLIC_URL") or os.getenv("MONGO_URL") or os.getenv("MONGODB_URI")
if not MONGO_URL:
    raise SystemExit("Falta MONGO_PUBLIC_URL, MONGO_URL o MONGODB_URI en el entorno")
