#!/usr/bin/env python3
# scripts/diagnostico/diagnostico_contactos_panel.py
"""
...
Uso:
    python scripts/diagnostico/diagnostico_contactos_panel.py
    python scripts/diagnostico/diagnostico_contactos_panel.py --skip-hubspot   # más rápido
    python scripts/diagnostico/diagnostico_contactos_panel.py --clean-ghosts   # elimina fantasmas de Redis
"""
