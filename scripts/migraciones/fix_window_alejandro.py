...
Uso:
    python scripts/migraciones/fix_window_alejandro.py
    python scripts/migraciones/fix_window_alejandro.py +573001110005   ← otro teléfono
"""
import os
import sys
import redis
...
phone = sys.argv[1] if len(sys.argv) > 1 else "+573001110006"
key   = f"{PREFIX}{phone}"
