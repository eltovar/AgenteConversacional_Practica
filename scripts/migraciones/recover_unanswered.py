"""
scripts/migraciones/recover_unanswered.py
=============================
...
Uso:
    python scripts/migraciones/recover_unanswered.py                   # interactivo, dry-run
    python scripts/migraciones/recover_unanswered.py --execute         # interactivo, aplica
    python scripts/migraciones/recover_unanswered.py --stage both --hours 72 --filter post-bot --execute
"""
