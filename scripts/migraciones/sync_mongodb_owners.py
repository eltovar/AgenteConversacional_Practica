...
Uso:
    python scripts/migraciones/sync_mongodb_owners.py              # dry-run (solo reporta)
    python scripts/migraciones/sync_mongodb_owners.py --apply      # aplica los cambios
    python scripts/migraciones/sync_mongodb_owners.py --apply --redis  # también corrige Redis meta
"""
