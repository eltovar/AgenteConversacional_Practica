...
class TestKBContentIntegrity:
    ...
    def test_departamentos_con_numeros_correctos(self):
        """
        Todas las areas publican el MISMO numero (decision de negocio, 19-ago-2026).
        Antes cada departamento tenia el suyo; ahora un numero distinto en la KB
        es un rastro viejo que Sofia acabaria dandole a un cliente.
        """
        numeros_esperados = {
            "604 444 63 64": "todas las areas",
        }
...
class TestInformacionInstitucional:
    ...
    PREGUNTAS_INSTITUCIONAL = [
        ...
        ("¿Cómo contacto a un asesor comercial?", "604 444 63 64"),
        ("Quiero hablar con un asesor para ver apartamentos", "604 444 63 64"),
        ("¿Cuál es el WhatsApp de asesores?", "604 444 63 64"),
    ]
...
class TestSoporteDepartamentos:
    ...
    CASOS_SOPORTE = [
        ("¿A quién llamo por un daño en el apartamento?",          "604 444 63 64",  "Reparaciones"),
        ("Tengo problemas con la factura EPM",                     "604 444 63 64", "Servicios Públicos"),
        ("Quiero hablar con el abogado",                           "604 444 63 64", "Jurídico"),
        ("¿Cuánto es la administración del conjunto?",             "604 444 63 64",  "Administraciones"),
        ...
        ("Estoy en mora, ¿cómo hago un acuerdo de pago?",         "604 444 63 64",  "Cartera"),
        ("Tengo una deuda de arriendo, ¿qué puedo hacer?",        "604 444 63 64",  "Cartera"),
        ("¿Con quién hablo si no puedo pagar el arriendo?",       "604 444 63 64",  "Cartera"),
    ]
