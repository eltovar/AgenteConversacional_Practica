...
class TestFix1_DynamicCanals:
    ...
    async def test_dynamic_canal_removal():
        ...
        result = await remove_from_advisor_inbox_test("89096380", "+573001110058", canal="ciencuadras")
        
        assert result, "❌ FAIL: Canal 'ciencuadras' no fue removido"
        mock_redis.zrem.assert_called_with("advisor_inbox:89096380", "+573001110058:ciencuadras")
...
class TestFix5_FrontendUnshift:
    ...
    def test_unshift_logic():
        ...
        all_contacts = [
            {"phone": "+573001110059", "name": "Contact 2", "unread": 0},
            {"phone": "+573001110060", "name": "Contact 3", "unread": 0},
        ]
        
        # Simular nuevo mensaje para "+573001110059"
        scroll_phone = "+573001110059"
